...
const Info = () => {
  const { weather, hourlyForecast, dailyForecast, error, loading } =
    useContext(WeatherContext);

  return (
    <>
      {loading && (
        <h1 className="text-white fw-bold text-center alert">Loading...</h1>
      )}
      {error && (
        <h1 className="text-white text-center fw-bold alert">{error}</h1>
      )}
        ...
        <Row className="text-main info">
            ...
            >
              <div className="text">
                ...
                <p className="text-sec fw-semibold">
                  Today, {new Date(weather.dt * 1000).getDate()}{" "}
          ...
          <Col md={4}>
            <div className="seven-days">
              <h6 className="text-sec text-uppercase fw-bold">
                7-Days forecast
              </h6>
